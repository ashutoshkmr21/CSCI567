...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        # self.params['W'] = np.random.randn(input_D, output_D) * 0.01
        # self.params['b'] = np.zeros((1, output_D))
...
class relu:
    ...
    def backward(self, X, grad):
        ...
        # backward_output = np.where(X > 0, grad, 0)
...
class tanh:
    ...
    def backward(self, X, grad):
        ...
        ####################################################################################################
        A = self.forward(X)
        backward_output = np.multiply(grad, (1 - np.square(A)))
